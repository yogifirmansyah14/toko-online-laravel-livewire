                    ...
                    <form action="{{ url('admin/category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <img src="{{ asset('uploads/category/'.$category->image) }}" alt="" width="100px" heigth="100px">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="meta_keyword" class="form-control" id="" cols="30" rows="10">{{ $category->meta_keyword }}</textarea>
