                    ...
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            <h4 class="text-primary">
                                Item Total Amount :
                                <span class="float-end">{{ currency_IDR($totalProductAmount) }}</span>
                            </h4>
                            <hr>
                                ...
                                <div class="col-md-12 mb-3" wire:ignore>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <button wire:loading.attr="disabled" class="nav-link fw-bold active" id="cashOnDeliveryTab-tab" data-bs-toggle="pill" data-bs-target="#cashOnDeliveryTab" type="button" role="tab" aria-controls="cashOnDeliveryTab" aria-selected="true">Cash on Delivery</button>
...
@push('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AfawUnqx0KTgzo2-x_YEE9U2qqIOXSy2yTE90-Ic473S7i38Kgs1uQ1clNRrvSkpOBWiyhwx0ZMUuYtH&currency=USD"></script>
    <script>
      paypal.Buttons({
        onClick: function()  {
        ...
        createOrder: (data, actions) => {
          return actions.order.create({
            purchase_units: [{
              amount: {
                value: '0.01' // "{{ $totalProductAmount }}" // Can also reference a variable or function
              }
            }]
          });
        },
